...
public final class GamePreferences {
    ...
    public static void saveCheckpoint(RunCheckpoint checkpoint) {
        ...
        p.putInteger("checkpoint.knives", checkpoint.knives);
        p.putInteger("checkpoint.knifeCapacity", checkpoint.knifeCapacity);
        p.flush();
    }
    ...
    public static RunCheckpoint loadCheckpoint() {
        ...
        checkpoint.capture(
            ...
            p.getInteger("checkpoint.knives", 1),
            p.getInteger("checkpoint.knifeCapacity", 1)
        );
        return checkpoint;
    }
